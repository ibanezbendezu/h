				...
				<div className="grid grid-cols-2 gap-3">
					<div className="space-y-4">
						...
						<div className="space-y-2">
							<CodeViewer code={file1Content} language={pair.file1?.language} highlightRange={pair.file1?.fragments} color={"#4d4d4d"} shouldScrollY={true} />
						</div>
					</div>
					<div className="space-y-4">
						<div className="flex justify-between items-center gap-2">
						...
						{loading ? (
							...
							<div className="space-y-2">
							<CodeViewer code={file2Content} language={pair.file2?.language} highlightRange={pair.file2?.fragments} color={"#4d4d4d"} shouldScrollY={true} />
							</div>
						)}
					</div>
				</div>
