...
import {clusterDataRequest, clusterDataRequestBySha, pairSimilaritiesByClusterRequest, pairSimilaritiesByClusterShaRequest} from "@/api/server-data";
import {Box, CalendarClock, Folder, Eye, FileCode, Workflow, ArrowBigRight, ArrowRight} from "lucide-react";
import {PiGraph, PiGraphLight} from "react-icons/pi";
    ...
    return (
        <div className="m-10 grid grid-flow-row gap-2">
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                <Card className="hover:bg-primary/5 cursor-pointer" onClick={() => onGraph(cluster?.id)}>
                    <CardHeader>
                                        ...
                                        <AccordionItem key={index} value={index.toString()}>
                                            <AccordionTrigger className="p-2 hover:bg-primary/5">
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <Badge variant="color" className="pointer-events-none" style={{ backgroundColor: rgbToHex(colorScale(folder.fever * 100)) }}>
                                                        <span className="text-xs">
                                                            {"score grupo: "}
                                                ...
                                                {folder.children.map((file: any, index: any) => (
                                                    <div key={index} className="p-2 flex items-center justify-between hover:bg-primary/5">
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <Badge variant="color" className="pointer-events-none" style={{ backgroundColor: rgbToHex(colorScale(file.fever * 100)) }}>
                                                                <span className="text-xs">
                                                                    {"score grupo: "}
                                                            ...
                                                            <Badge variant="secondary" className="hover:bg-primary/10 cursor-pointer" onClick={() => onSelect(file.sha)}>
                                                                {"ver"}
